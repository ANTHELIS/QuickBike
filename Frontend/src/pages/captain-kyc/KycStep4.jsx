  ...
  const steps = [
    {
      ...
      done: kyc?.drivingLicenseFront && kyc?.drivingLicenseBack,
      detail: kyc?.licenseNumber ? `License # ending in ${kyc.licenseNumber.slice(-4)}` : 'Uploaded',
      editPath: '/captain/kyc/step/1',
    },
    {
      icon: 'fa-motorcycle',
      title: 'Vehicle Info',
      done: kyc?.vehicleNumber && kyc?.vehicleModel,
      detail: kyc ? `${kyc.vehicleModel} (${kyc.vehicleColor || 'N/A'})` : '',
      editPath: '/captain/kyc/step/3',
    },
    {
      icon: 'fa-person',
      title: 'National ID / Passport',
      done: kyc?.idCardFront && kyc?.idCardBack,
