...
const ConfirmRidePopUp = (props) => {
  ...
  return (
    <div>
      {/* Close handle */}
      <div onClick={() => { props.setConfirmRidePopupPanel(false); props.setRidePopupPanel(false) }} style={{ display: 'flex', justifyContent: 'center', paddingBottom: '16px', cursor: 'pointer' }}>
      ...
      <h3 className="headline-md" style={{ marginBottom: '16px' }}>
        Confirm ride to start<span style={{ color: 'var(--primary-container)' }}>.</span>
      </h3>
      ...
      {/* Fare */}
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 16px', background: 'var(--surface-container-low)', borderRadius: 'var(--radius-lg)', marginBottom: '20px' }}>
